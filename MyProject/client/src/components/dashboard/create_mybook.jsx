...
export default class CreateMyBook extends React.Component {
    render() {
        return (
            <div>
                <div>
                            ...
                            <form className="needs-validation" name="userForm" encType="multipart/form-data">
                                <div className="row fw-bold text-start justify-content-center">
                                    <div className="col-4">
                                        ...
                                        <div className="form-group">
                                            <label className="form-label mt-4" htmlFor="Description">Description</label><br/>
                                    ...
                                    <div className="col-4">
                                        ...
                                        <div className="form-group">
                                            <label className="form-label mt-4" htmlFor="Date Publish">Date Publish</label><br/>
